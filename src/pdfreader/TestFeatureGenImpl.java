...
public class TestFeatureGenImpl extends FeatureGenImpl {
    /**
	 * 
	 */
...
//            strToInt.put(feature.identifier().clone(), new Integer(newId));
        ...
        public int read(BufferedReader in) throws IOException {
            ...
            for(l = 0; (l < len) && ((line=in.readLine())!=null); l++) {
                ...
                int before = strToInt.size();
                strToInt.put(key,new FeatureImpl(pos,key));
                if (strToInt.size() == before) {
    ...
    public TestFeatureGenImpl(String modelSpecs, int numLabels) throws Exception {
        super(modelSpecs, numLabels);
        featureMap = new FeatureMap();
    }
    public TestFeatureGenImpl(String modelSpecs, int numLabels, boolean addFeatureNow) throws Exception {
        super(modelSpecs, numLabels, addFeatureNow);
    }
    public TestFeatureGenImpl(Model m, int numLabels, boolean addFeatureNow) throws Exception {
